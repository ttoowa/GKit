...
namespace WintabDN
{
    ...
    public class WFuncs
    {
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern uint WTOpenA(IntPtr hWnd_I, ref WintabLogContext logContext_I, bool enable_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTClose(uint hctx_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTEnable(uint hctx_I, bool enable_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTOverlap(uint hctx_I, bool toTop_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern uint WTQueueSizeGet(uint hctx_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTQueueSizeSet(uint hctx_I, uint nPkts_I);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTPacket(uint hctx_I, uint pktSerialNum_I, IntPtr pktBuf_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern uint WTPacketsGet(uint hctx_I, uint maxPkts_I, IntPtr pktBuf_O);     
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern uint WTDataGet(uint hctx_I, uint pktIDStart_I, uint pktIDEnd_I,
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern uint WTDataPeek(uint hctx_I, uint pktIDStart_I, uint pktIDEnd_I,
            uint maxPkts_I, IntPtr pktBuf_O, ref uint numPkts_O);
        ...
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTQueuePacketsEx(uint hctx_I, ref uint pktIDOldest_O, ref uint pktIDNewest_O);
        ...
        /// <returns></returns>
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTExtGet(uint hctx_I, uint extTag_I, IntPtr extData_O);
        ...
        /// <returns></returns>
        [DllImport("Wintab32.dll", CharSet = CharSet.Auto)]
        public static extern bool WTExtSet(uint hctx_I, uint extTag_I, IntPtr extData_I);
    }
