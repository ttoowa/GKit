...
namespace GKit {
	public class CoreRoutineEvent {
		...
		public static CoreRoutineEvent operator +(CoreRoutineEvent left, Func<IEnumerator> right) {
			left.Add(right);
			return left;
		}
		public static CoreRoutineEvent operator -(CoreRoutineEvent left, Func<IEnumerator> right) {
